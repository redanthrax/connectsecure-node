...
export const getAllDescription: INodeProperties[] = [
	{
		...
		displayOptions: { show: { resource: ['reportQueriesSwProblemsRemediationsViewAssetwise'], operation: ['getAll'] } },
		default: false,
	},
	{
		displayName: 'Limit',
		...
		displayOptions: { show: { resource: ['reportQueriesSwProblemsRemediationsViewAssetwise'], operation: ['getAll'], returnAll: [false] } },
	...
	},
	{
		...
		displayOptions: {
			show: { resource: ['reportQueriesSwProblemsRemediationsViewAssetwise'], operation: ['getAll'], filterMode: ['manual'] },
		},
	},
	{
		displayName: 'Filters',
		...
		displayOptions: {
			show: { resource: ['reportQueriesSwProblemsRemediationsViewAssetwise'], operation: ['getAll'], filterMode: ['builder'] },
		},
		options: [
			{
				name: 'filter',
	...
	},
	{
		...
		displayOptions: {
			show: { resource: ['reportQueriesSwProblemsRemediationsViewAssetwise'], operation: ['getAll'], orderByMode: ['manual'] },
		},
	},
	{
		...
		displayOptions: {
			show: { resource: ['reportQueriesSwProblemsRemediationsViewAssetwise'], operation: ['getAll'], orderByMode: ['builder'] },
		},
		options: [
			{
				name: 'field',
