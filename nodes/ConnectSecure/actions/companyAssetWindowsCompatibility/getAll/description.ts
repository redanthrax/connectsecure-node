...
export const getAllDescription: INodeProperties[] = [
	{
		...
		displayOptions: { show: { resource: ['companyAssetWindowsCompatibility'], operation: ['getAll'] } },
		default: false,
	},
	{
		displayName: 'Limit',
		...
		displayOptions: { show: { resource: ['companyAssetWindowsCompatibility'], operation: ['getAll'], returnAll: [false] } },
	...
	},
	{
		...
		displayOptions: {
			show: { resource: ['companyAssetWindowsCompatibility'], operation: ['getAll'], filterMode: ['manual'] },
		},
	},
	{
		displayName: 'Filters',
		...
		displayOptions: {
			show: { resource: ['companyAssetWindowsCompatibility'], operation: ['getAll'], filterMode: ['builder'] },
		},
		options: [
			{
				name: 'filter',
	...
	},
	{
		...
		displayOptions: {
			show: { resource: ['companyAssetWindowsCompatibility'], operation: ['getAll'], orderByMode: ['manual'] },
		},
	},
	{
		...
		displayOptions: {
			show: { resource: ['companyAssetWindowsCompatibility'], operation: ['getAll'], orderByMode: ['builder'] },
		},
		options: [
			{
				name: 'field',
