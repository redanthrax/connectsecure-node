...
export const getAllDescription: INodeProperties[] = [
	{
		...
		displayOptions: { show: { resource: ['companyComplianceAssessment'], operation: ['getAll'] } },
		default: false,
	},
	{
		displayName: 'Limit',
		...
		displayOptions: { show: { resource: ['companyComplianceAssessment'], operation: ['getAll'], returnAll: [false] } },
	...
	},
	{
		...
		displayOptions: {
			show: { resource: ['companyComplianceAssessment'], operation: ['getAll'], filterMode: ['manual'] },
		},
	},
	{
		displayName: 'Filters',
		...
		displayOptions: {
			show: { resource: ['companyComplianceAssessment'], operation: ['getAll'], filterMode: ['builder'] },
		},
		options: [
			{
				name: 'filter',
	...
	},
	{
		...
		displayOptions: {
			show: { resource: ['companyComplianceAssessment'], operation: ['getAll'], orderByMode: ['manual'] },
		},
	},
	{
		...
		displayOptions: {
			show: { resource: ['companyComplianceAssessment'], operation: ['getAll'], orderByMode: ['builder'] },
		},
		options: [
			{
				name: 'field',
