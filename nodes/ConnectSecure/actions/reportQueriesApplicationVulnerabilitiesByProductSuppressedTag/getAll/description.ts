...
export const getAllDescription: INodeProperties[] = [
	{
		...
		displayOptions: { show: { resource: ['reportQueriesApplicationVulnerabilitiesByProductSuppressedTag'], operation: ['getAll'] } },
		default: false,
	},
	{
		displayName: 'Limit',
		...
		displayOptions: { show: { resource: ['reportQueriesApplicationVulnerabilitiesByProductSuppressedTag'], operation: ['getAll'], returnAll: [false] } },
	...
	},
	{
		...
		displayOptions: {
			show: { resource: ['reportQueriesApplicationVulnerabilitiesByProductSuppressedTag'], operation: ['getAll'], filterMode: ['manual'] },
		},
	},
	{
		displayName: 'Filters',
		...
		displayOptions: {
			show: { resource: ['reportQueriesApplicationVulnerabilitiesByProductSuppressedTag'], operation: ['getAll'], filterMode: ['builder'] },
		},
		options: [
			{
				name: 'filter',
	...
	},
	{
		...
		displayOptions: {
			show: { resource: ['reportQueriesApplicationVulnerabilitiesByProductSuppressedTag'], operation: ['getAll'], orderByMode: ['manual'] },
		},
	},
	{
		...
		displayOptions: {
			show: { resource: ['reportQueriesApplicationVulnerabilitiesByProductSuppressedTag'], operation: ['getAll'], orderByMode: ['builder'] },
		},
		options: [
			{
				name: 'field',
