...
export const getAllDescription: INodeProperties[] = [
	{
		...
		displayOptions: { show: { resource: ['reportQueriesPortsAssetsDetails'], operation: ['getAll'] } },
		default: false,
	},
	{
		displayName: 'Limit',
		...
		displayOptions: { show: { resource: ['reportQueriesPortsAssetsDetails'], operation: ['getAll'], returnAll: [false] } },
	...
	},
	{
		...
		displayOptions: {
			show: { resource: ['reportQueriesPortsAssetsDetails'], operation: ['getAll'], filterMode: ['manual'] },
		},
	},
	{
		displayName: 'Filters',
		...
		displayOptions: {
			show: { resource: ['reportQueriesPortsAssetsDetails'], operation: ['getAll'], filterMode: ['builder'] },
		},
		options: [
			{
				name: 'filter',
	...
	},
	{
		...
		displayOptions: {
			show: { resource: ['reportQueriesPortsAssetsDetails'], operation: ['getAll'], orderByMode: ['manual'] },
		},
	},
	{
		...
		displayOptions: {
			show: { resource: ['reportQueriesPortsAssetsDetails'], operation: ['getAll'], orderByMode: ['builder'] },
		},
		options: [
			{
				name: 'field',
